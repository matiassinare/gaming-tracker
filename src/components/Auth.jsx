...
export default function Auth({ onAuthSuccess, initialMode = 'signin' }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white flex items-center justify-center px-3 sm:px-4 py-4">
      <div className="bg-slate-800 p-6 sm:p-8 rounded-lg shadow-xl max-w-md w-full">
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold mb-2">🎮 Backlog 2026</h1>
